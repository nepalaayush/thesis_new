...
path_neg = '/data/projects/ma-nepal-segmentation/data/data_20_03/AN_W_ai2_tgv_5e-2_neg_ngn.nii'
path_pos = '/data/projects/ma-nepal-segmentation/data/data_20_03/AN_W_ai2_tgv_5e-2_pos_ngn.nii'
#%%
...
new_tib_coords_first[0] = AN_NW_ref_frame_fem_stiched
#viewer.add_points(reference_frame_first, face_color='orange', size =1, name='reference_frame_first')
viewer.add_points(AN_NW_ref_frame_fem_stiched, face_color='green', size =1, name='reference_frame_first_using_NW_fem')
...
with open('AN_W_t_matrices_fem_stiched.pkl', 'wb') as file:
