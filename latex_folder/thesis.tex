...
In a broad sense, dynamic MRI can be considered to be an imaging technique that is designed to capture and visualize motion or physiological processes as they occur in the scanner. These might include blood flow, heart movements or in our case, joint movement.  
