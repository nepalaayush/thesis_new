...
tib_info = process_multi_frame(shapes_data, full_image.shape)

fem_info = process_multi_frame(viewer.layers['femur'], full_image.shape)

#%%
ds1_angles_nw = calculate_and_plot_angles_between_bones(tib_info, fem_info, name='ds_1_NW')
